...
export default function HauntedHouse() {
    useEffect(() => {
        ...
        const grassAmbientOcclusionTexture = textureLoader.load('//statictextures/grass/ambientOcclusion.jpg')
        ...
        //ROOF
        const roof = new THREE.Mesh(new THREE.ConeGeometry(3.5, 1, 4), new THREE.MeshStandardMaterial({ color: 'aa7b7b' }))
        house.add(roof)
        ...
        const door = new THREE.Mesh(new THREE.PlaneGeometry(2, 2, 100, 100),
            new THREE.MeshStandardMaterial({
                ...
                transparent: true, alphaMap: doorAlphaTexture,
